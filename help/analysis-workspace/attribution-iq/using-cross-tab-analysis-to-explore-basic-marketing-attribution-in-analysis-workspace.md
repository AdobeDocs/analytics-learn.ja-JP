...
* 3:20 - クロス タブ ディメンションは、ドロップすると自動的に動的になります。つまり、値は時間の経過とともに変化する可能性があります。 この分析では、代わりに静的列を引き継ぐことをお勧めします。 ビデオの6:33で動的な列について詳しく説明します。[自由形式テーブルの行と列の設定](../building-freeform-tables/row-and-column-settings-in-freeform-tables.md)
* 4:30 – 列の設定を1行ずつ更新するのではなく、一括で更新できます。 ビデオの8:45で詳しく説明します：[自由形式テーブルの行と列の設定](../building-freeform-tables/row-and-column-settings-in-freeform-tables.md)
