...
カスタムDimension コホートテーブルでは、平均よりもリテンション率の高い製品をハイライト表示します。  この表は、注目に値する上位の製品を使用した内部および外部のマーケティングキャンペーンを推進するための上位の製品を特定するのに役立ちます。
...
**Jennifer Yacenda**、マリオット社シニアディレクター
