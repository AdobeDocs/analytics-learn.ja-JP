...
>[!VIDEO](https://video.tv.adobe.com/v/346459/?captions=jpn&quality=12&learn=on)

_すべて_。 これは、次の質問に対する最も一般的な回答です。_どのようなデータを追跡しますか？_ _実用的なデータポイント_&#x200B;を特定して収集することは、可能なすべての要素を記録するよりも価値があります。 これらのデータポイントを効率的に特定するには、基本的な計画と関係者との創造的な議論が必要です。
