...
すべての部門には、通常、Adobe Analytics に精通した高度なユーザーが 1 人はいます。 彼らの専門知識を活用し、彼らと協力して「Adobe Analyticsのデパートリーリーダー」になってください。 このサポートレベルを作成することで、利用者がスキルセットを向上させ、Adobe Analyticsへの投資を増やし、より高度で困難な質問に時間を割くことができるようになります。
