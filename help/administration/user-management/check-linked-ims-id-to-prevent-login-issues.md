...
description: Adobe Analytics で IMS ID が間違っている、または欠落している場合、ユーザーのログインに問題が生じる可能性があります。ユーザーは、リンクされた IMS ID 自体を確認し、問題がある場合はカスタマーサポートに問い合わせることができるので、一般的なトラブルシューティング手順を実行する手間を省くことができます。
