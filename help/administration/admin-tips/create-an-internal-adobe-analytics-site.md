...
**WHAT:** トレーニングドキュメントの作成に関する[このヒント &#x200B;](create-basic-videos-and-training.md){target="_blank"}の推奨事項に従っている場合、ハードドライブに保存することはできません。 これらのドキュメントを共有し、すべてのユーザーが参照できる一元的な場所を作成します。内部の Adobe Analytics サイト（Confluence など）では、これらのドキュメントをすべて投稿し、様々なバージョンを維持できます。
