...
>[!WARNING]
>
>Report Suite Managerでの分類の管理と読み込みは、2026年8月31日（PT）に非推奨（廃止予定）になります。 引き続き機能を使用するには、分類セットのエクスペリエンスを切り替えて使用してください。
...
>[!VIDEO](https://video.tv.adobe.com/v/40934/?captions=jpn&quality=12&learn=on)
